...
#> (Intercept)    -0.00315     1e-05  -0.00435  -0.00221    |    -0.00767
#> COLCAP.lag(1)   0.14521     1e-02   0.03710   0.23835    |     0.02218
#> BOVESPA.lag(1)  0.07307     2e-02   0.01023   0.12945    |    -0.00333
#>                 2(1-PD)  HDI.Lower HDI.Upper
#> (Intercept)      0.00001  -0.00959  -0.00624
#> COLCAP.lag(1)    0.70000  -0.11571   0.15906
#> BOVESPA.lag(1)   0.96000  -0.09872   0.08169
#> 
...
#> Autoregressive coefficients
#>                    Mean  2(1-PD)  HDI.Lower HDI.Upper             Mean
#> (Intercept)     0.00454   0.00001   0.00291   0.00575    |     0.01077
#> COLCAP.lag(1)   0.07469   0.19000  -0.04480   0.18811    |     0.17885
#> BOVESPA.lag(1)  0.07610   0.10000  -0.00426   0.16320    |    -0.10311
#> COLCAP.lag(2)   0.06979   0.24000  -0.04207   0.17986    |    -0.05523
#> BOVESPA.lag(2) -0.07117   0.08000  -0.14307   0.00151    |    -0.07217
#>                 2(1-PD)  HDI.Lower HDI.Upper
#> (Intercept)      0.00001   0.00723   0.01282
#> COLCAP.lag(1)    0.05000   0.01964   0.35975
#> BOVESPA.lag(1)   0.18000  -0.22896   0.04830
#> COLCAP.lag(2)    0.45000  -0.21912   0.10913
#> BOVESPA.lag(2)   0.26000  -0.19397   0.04272
#> 
#> Scale parameter (Mean, HDI.Lower, HDI.Upper)
#>         COLCAP BOVESPA      COLCAP BOVESPA      COLCAP BOVESPA
...
#> Autoregressive coefficients
#>                    Mean  2(1-PD)  HDI.Lower HDI.Upper             Mean
#> (Intercept)     1.31958   0.00001   1.10008   1.52486    |     3.42595
#> Bedon.lag(1)    0.56273   0.00001   0.48530   0.64222    |     0.15309
#> LaPlata.lag(1)  0.04636   0.01000   0.01698   0.07564    |     0.63175
#> Bedon.lag(2)    0.05184   0.12000  -0.00963   0.12150    |    -0.04127
#> LaPlata.lag(2) -0.02141   0.11000  -0.04671   0.00248    |    -0.06872
#> Bedon.lag(3)    0.02871   0.34000  -0.02925   0.08419    |     0.02550
#> LaPlata.lag(3)  0.00358   0.74000  -0.01925   0.02188    |     0.06490
#> Bedon.lag(4)    0.03095   0.42000  -0.02292   0.10501    |    -0.09161
#> LaPlata.lag(4) -0.01575   0.07000  -0.03064   0.00271    |     0.00834
#> Bedon.lag(5)    0.08781   0.01000   0.04279   0.13970    |     0.15201
#> LaPlata.lag(5) -0.00709   0.30000  -0.02105   0.00494    |     0.02453
#>                 2(1-PD)  HDI.Lower HDI.Upper
#> (Intercept)      0.00001   2.89878   3.94294
#> Bedon.lag(1)     0.12000  -0.02699   0.32427
#> LaPlata.lag(1)   0.00001   0.55630   0.69946
#> Bedon.lag(2)     0.59000  -0.24202   0.13051
#> LaPlata.lag(2)   0.05000  -0.12874   0.00028
#> Bedon.lag(3)     0.78000  -0.09573   0.13986
#> LaPlata.lag(3)   0.02000   0.01208   0.11560
#> Bedon.lag(4)     0.32000  -0.25213   0.07669
#> LaPlata.lag(4)   0.73000  -0.04248   0.05712
#> Bedon.lag(5)     0.04000   0.03244   0.28216
#> LaPlata.lag(5)   0.22000  -0.01569   0.06791
#> 
#> Scale parameter (Mean, HDI.Lower, HDI.Upper)
...
#> Autoregressive coefficients
#>                    Mean  2(1-PD)  HDI.Lower HDI.Upper             Mean
#> (Intercept)     2.12773   0.00001   1.25691   2.89565    |     6.86550
#> Bedon.lag(1)    0.58630   0.00001   0.49038   0.66428    |     0.13516
#> LaPlata.lag(1)  0.02297   0.10000  -0.00267   0.05492    |     0.53815
#> Bedon.lag(2)    0.10093   0.07000  -0.01950   0.22289    |    -0.00644
#> LaPlata.lag(2) -0.02127   0.19000  -0.05010   0.01247    |     0.03156
#> Bedon.lag(3)   -0.03765   0.55000  -0.13902   0.07273    |    -0.06951
#> LaPlata.lag(3) -0.00965   0.57000  -0.04066   0.02081    |     0.03781
#> Bedon.lag(4)    0.10571   0.04000   0.00065   0.20215    |     0.24022
#> LaPlata.lag(4)  0.00729   0.67000  -0.02064   0.03557    |    -0.04182
#> Bedon.lag(5)    0.02357   0.60000  -0.05353   0.09066    |    -0.25951
#> LaPlata.lag(5)  0.00539   0.71000  -0.02087   0.03213    |     0.11140
#>                 2(1-PD)  HDI.Lower HDI.Upper
#> (Intercept)      0.00001   5.07360   9.01380
#> Bedon.lag(1)     0.24000  -0.03774   0.39103
#> LaPlata.lag(1)   0.00001   0.45389   0.61551
#> Bedon.lag(2)     0.97000  -0.23228   0.21766
#> LaPlata.lag(2)   0.29000  -0.02985   0.09888
#> Bedon.lag(3)     0.56000  -0.29094   0.12953
#> LaPlata.lag(3)   0.28000  -0.01787   0.12010
#> Bedon.lag(4)     0.05000   0.01957   0.51771
#> LaPlata.lag(4)   0.36000  -0.12220   0.02683
#> Bedon.lag(5)     0.00001  -0.46358  -0.08504
#> LaPlata.lag(5)   0.01000   0.04027   0.18512
#> 
#> Scale parameter (Mean, HDI.Lower, HDI.Upper)
#>           Bedon LaPlata        Bedon LaPlata        Bedon LaPlata
...
#> Autoregressive coefficients
#>                    Mean  2(1-PD)  HDI.Lower HDI.Upper             Mean
#> (Intercept)     5.57818   0.00001   4.15873   7.31318    |    16.62186
#> Bedon.lag(1)    0.45329   0.00001   0.29600   0.59888    |     0.54495
#> LaPlata.lag(1)  0.04782   0.00001   0.01926   0.08698    |     0.33651
#> Bedon.lag(2)    0.09096   0.17000  -0.04469   0.25465    |    -0.55935
#> LaPlata.lag(2) -0.00384   0.76000  -0.03642   0.02447    |     0.11513
#> Bedon.lag(3)   -0.09691   0.06000  -0.20252   0.00392    |    -0.61606
#> LaPlata.lag(3)  0.03740   0.06000   0.00901   0.07426    |     0.28741
#> Bedon.lag(4)    0.00482   0.91000  -0.13156   0.12932    |     0.09580
#> LaPlata.lag(4)  0.00017   0.98000  -0.04035   0.04070    |    -0.01665
#> Bedon.lag(5)    0.18776   0.01000   0.07240   0.35826    |     0.25929
#> LaPlata.lag(5) -0.01446   0.48000  -0.05217   0.01886    |     0.06727
#>                 2(1-PD)  HDI.Lower HDI.Upper
#> (Intercept)      0.00001  10.31207  22.63209
#> Bedon.lag(1)     0.05000  -0.01386   1.07966
#> LaPlata.lag(1)   0.00001   0.21900   0.49800
#> Bedon.lag(2)     0.05000  -1.13000  -0.01892
#> LaPlata.lag(2)   0.10000  -0.02077   0.26954
#> Bedon.lag(3)     0.00001  -0.98236  -0.17635
#> LaPlata.lag(3)   0.00001   0.15241   0.43315
#> Bedon.lag(4)     0.77000  -0.48734   0.62058
#> LaPlata.lag(4)   0.82000  -0.17667   0.11111
#> Bedon.lag(5)     0.27000  -0.21102   0.67940
#> LaPlata.lag(5)   0.23000  -0.01569   0.22868
#> 
#> Scale parameter (Mean, HDI.Lower, HDI.Upper)
#>           Bedon  LaPlata        Bedon  LaPlata        Bedon  LaPlata
