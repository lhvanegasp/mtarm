...
#> (Intercept)    -0.00582   0.00001  -0.00716  -0.00454    |    -0.01198
#> COLCAP.lag(1)   0.19945   0.01500   0.03838   0.33862    |    -0.07778
#> BOVESPA.lag(1)  0.08901   0.07500  -0.00384   0.18230    |     0.04848
#>                 2(1-PD)  HDI.Lower HDI.Upper
#> (Intercept)      0.00001  -0.01380  -0.01025
#> COLCAP.lag(1)    0.44100  -0.27638   0.12791
#> BOVESPA.lag(1)   0.48000  -0.08542   0.18492
#> 
...
#> Autoregressive coefficients
#>                    Mean  2(1-PD)  HDI.Lower HDI.Upper             Mean
#> (Intercept)     0.00631   0.00001   0.00420   0.00797    |     0.01440
#> COLCAP.lag(1)   0.07935   0.27200  -0.05357   0.22234    |     0.15600
#> BOVESPA.lag(1) -0.00454   0.93000  -0.13338   0.12069    |    -0.19440
#> COLCAP.lag(2)   0.06576   0.31300  -0.06714   0.19769    |    -0.07022
#> BOVESPA.lag(2) -0.06115   0.23900  -0.16038   0.03701    |    -0.03683
#>                 2(1-PD)  HDI.Lower HDI.Upper
#> (Intercept)      0.00001   0.01062   0.01742
#> COLCAP.lag(1)    0.12600  -0.04119   0.35994
#> BOVESPA.lag(1)   0.02400  -0.36899  -0.02604
#> COLCAP.lag(2)    0.47900  -0.27017   0.12001
#> BOVESPA.lag(2)   0.60000  -0.17876   0.11750
#> 
#> Scale parameter (Mean, HDI.Lower, HDI.Upper)
#>         COLCAP BOVESPA      COLCAP BOVESPA      COLCAP BOVESPA
...
#> Autoregressive coefficients
#>                    Mean  2(1-PD)  HDI.Lower HDI.Upper             Mean
#> (Intercept)     1.32270   0.00001   1.10840   1.53769    |     3.44215
#> Bedon.lag(1)    0.56779   0.00001   0.48674   0.63865    |     0.15306
#> LaPlata.lag(1)  0.04606   0.00001   0.01783   0.07252    |     0.63452
#> Bedon.lag(2)    0.04913   0.17600  -0.02108   0.11760    |    -0.04933
#> LaPlata.lag(2) -0.02122   0.09500  -0.04472   0.00348    |    -0.07052
#> Bedon.lag(3)    0.02670   0.38000  -0.02930   0.09340    |     0.02802
#> LaPlata.lag(3)  0.00382   0.73500  -0.01660   0.02593    |     0.06689
#> Bedon.lag(4)    0.03433   0.27100  -0.02619   0.09564    |    -0.09043
#> LaPlata.lag(4) -0.01488   0.08800  -0.03242   0.00125    |     0.00892
#> Bedon.lag(5)    0.08104   0.00100   0.02832   0.13178    |     0.14733
#> LaPlata.lag(5) -0.00696   0.32100  -0.02195   0.00594    |     0.02447
#>                 2(1-PD)  HDI.Lower HDI.Upper
#> (Intercept)      0.00001   2.84277   4.07806
#> Bedon.lag(1)     0.16100  -0.05636   0.36727
#> LaPlata.lag(1)   0.00001   0.55429   0.71943
#> Bedon.lag(2)     0.59300  -0.24435   0.13300
#> LaPlata.lag(2)   0.04500  -0.14001  -0.00314
#> Bedon.lag(3)     0.70700  -0.12634   0.16055
#> LaPlata.lag(3)   0.01300   0.01315   0.11782
#> Bedon.lag(4)     0.27800  -0.25017   0.06800
#> LaPlata.lag(4)   0.73200  -0.04320   0.05970
#> Bedon.lag(5)     0.01900   0.03063   0.27978
#> LaPlata.lag(5)   0.27100  -0.01913   0.06635
#> 
#> Scale parameter (Mean, HDI.Lower, HDI.Upper)
...
#> Autoregressive coefficients
#>                    Mean  2(1-PD)  HDI.Lower HDI.Upper             Mean
#> (Intercept)     2.16206   0.00001   1.35707   3.02750    |     6.99793
#> Bedon.lag(1)    0.58563   0.00001   0.49891   0.67580    |     0.14497
#> LaPlata.lag(1)  0.02201   0.10200  -0.00363   0.05119    |     0.52630
#> Bedon.lag(2)    0.09688   0.12800  -0.02828   0.21426    |    -0.00237
#> LaPlata.lag(2) -0.02007   0.23300  -0.05446   0.01355    |     0.03353
#> Bedon.lag(3)   -0.03512   0.55200  -0.14647   0.07395    |    -0.06173
#> LaPlata.lag(3) -0.00713   0.67100  -0.03772   0.02401    |     0.04288
#> Bedon.lag(4)    0.09802   0.12500  -0.02663   0.21782    |     0.21898
#> LaPlata.lag(4)  0.00786   0.65700  -0.02382   0.04139    |    -0.04288
#> Bedon.lag(5)    0.02923   0.50100  -0.05058   0.12382    |    -0.26840
#> LaPlata.lag(5)  0.00360   0.82300  -0.02547   0.03502    |     0.11670
#>                 2(1-PD)  HDI.Lower HDI.Upper
#> (Intercept)      0.00001   4.94275   9.10715
#> Bedon.lag(1)     0.21200  -0.07875   0.37675
#> LaPlata.lag(1)   0.00001   0.44707   0.60523
#> Bedon.lag(2)     0.99200  -0.23101   0.24794
#> LaPlata.lag(2)   0.38400  -0.04716   0.10488
#> Bedon.lag(3)     0.59000  -0.28219   0.18169
#> LaPlata.lag(3)   0.25800  -0.02779   0.11153
#> Bedon.lag(4)     0.10300  -0.04063   0.48358
#> LaPlata.lag(4)   0.30700  -0.12166   0.03660
#> Bedon.lag(5)     0.01500  -0.48299  -0.06350
#> LaPlata.lag(5)   0.00300   0.04428   0.19462
#> 
#> Scale parameter (Mean, HDI.Lower, HDI.Upper)
#>           Bedon LaPlata        Bedon LaPlata        Bedon LaPlata
...
#> Autoregressive coefficients
#>                    Mean  2(1-PD)  HDI.Lower HDI.Upper             Mean
#> (Intercept)     5.54232   0.00001   3.95604   7.10331    |    16.97342
#> Bedon.lag(1)    0.47503   0.00001   0.30809   0.65025    |     0.55576
#> LaPlata.lag(1)  0.04369   0.01800   0.00732   0.07755    |     0.32200
#> Bedon.lag(2)    0.08219   0.27700  -0.06799   0.23009    |    -0.56479
#> LaPlata.lag(2) -0.00346   0.82300  -0.03463   0.03605    |     0.12032
#> Bedon.lag(3)   -0.09216   0.17500  -0.21436   0.04701    |    -0.57825
#> LaPlata.lag(3)  0.03429   0.07700  -0.00179   0.07014    |     0.28292
#> Bedon.lag(4)    0.00065   0.97800  -0.15412   0.13770    |     0.02933
#> LaPlata.lag(4)  0.00412   0.86100  -0.03739   0.04583    |    -0.00476
#> Bedon.lag(5)    0.17995   0.00800   0.03964   0.31051    |     0.28306
#> LaPlata.lag(5) -0.01420   0.41200  -0.04734   0.02338    |     0.06208
#>                 2(1-PD)  HDI.Lower HDI.Upper
#> (Intercept)      0.00001  11.33475  22.78460
#> Bedon.lag(1)     0.03000   0.08824   1.08182
#> LaPlata.lag(1)   0.00001   0.20162   0.44473
#> Bedon.lag(2)     0.04200  -1.09287   0.01191
#> LaPlata.lag(2)   0.06100  -0.02109   0.25281
#> Bedon.lag(3)     0.01700  -1.06910  -0.12542
#> LaPlata.lag(3)   0.00001   0.13351   0.43195
#> Bedon.lag(4)     0.94900  -0.51977   0.58427
#> LaPlata.lag(4)   0.93200  -0.16977   0.15009
#> Bedon.lag(5)     0.27400  -0.17852   0.78211
#> LaPlata.lag(5)   0.34200  -0.06591   0.19247
#> 
#> Scale parameter (Mean, HDI.Lower, HDI.Upper)
#>           Bedon  LaPlata        Bedon  LaPlata        Bedon  LaPlata
